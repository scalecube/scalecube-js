...
export declare type ServiceCallResponse = Observable<any> | Promise<any>;
export declare type ServiceCall = (serviceCallRequest: ServiceCallOptions) => ServiceCallResponse;
...
declare type AddServiceToRegistry<T> = ({ services, address }: AvailableServices) => T;
