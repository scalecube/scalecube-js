...
describe('PostMessage tests', () => {
  ...
  //
  //   transport = new Transport();
  //   transport.setProvider(PostMessageProvider, { URI, keepAlive: 'test' }).catch((error) => {
  ...
  //
  //   transport = new Transport();
  //   transport.setProvider(PostMessageProvider, { URI, lifetime: 'test' }).catch((error) => {
  ...
  //
  //   transport = new Transport();
  //   transport.setProvider(PostMessageProvider, { URI, WebSocket: 'test' }).catch((error) => {
  ...
  // TODO This one is specific for Sockets
